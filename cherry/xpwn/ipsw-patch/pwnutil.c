...
void createRestoreOptions(Volume* volume, const char *optionsPlist, int SystemPartitionSize, int UpdateBaseband, int FlashNOR) {
	AbstractFile* plistFile;
	Dictionary* info;
	char* plist;
    ...
    addBoolToDictionary(info, "FlashNOR", FlashNOR);
